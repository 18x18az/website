...
function HeroImage (): JSX.Element {
  return (
    <div style={{ height: '60vh' }} className='relative m-0 p-0'>
      <Image src='https://static-18x18.azureedge.net/images/hero.webp' priority={true} sizes='100%' height={0} width={0} className='w-full object-cover h-full' alt='Teams competing' />
